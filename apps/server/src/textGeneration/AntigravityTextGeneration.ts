...
} from "../threadSubtitles/ThreadSubtitleGeneration.ts";
import {
  type ModelSelection,
...
export const makeAntigravityTextGeneration = Effect.fn("makeAntigravityTextGeneration")(function* (
  ...
  const generateThreadSubtitle: TextGeneration.TextGeneration["Service"]["generateThreadSubtitle"] =
    Effect.fn("AntigravityTextGeneration.generateThreadSubtitle")(function* (input) {
      const generated = yield* runAntigravityJson({
        operation: "generateThreadSubtitle",
        ...buildThreadSubtitlePrompt(input),
        modelSelection: input.modelSelection,
      });
