...
import { ProviderAccountsAutoSwitchHost } from "../components/accountSwitcher/AutoSwitchSubscription"; // fork: provider accounts
    ...
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        >
          ...
          <ProviderAccountsAutoSwitchHost /> {/* fork: provider accounts */}
