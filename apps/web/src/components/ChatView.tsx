...
export default function ChatView(props: ChatViewProps) {
  ...
  // The grid pane owns a local composer ref; regular routes may receive the shared one.
  // Keep the paste shortcut window local to this ChatView instance.
  ...
  const rightPanelPresenceValue = useMemo(
    () => ({ activeSurface: activeRightPanelSurface, surfaces: rightPanelState.surfaces }),
  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      {isGridPane && !shouldUseRightPanelSheet && ownsGlobalInteraction && rightPanelPortalTarget
        ...
        : null}
      {!isGridPane && rightPanelControlsAtRoot ? panelLayoutControls : null}
      <div
        className={cn(
